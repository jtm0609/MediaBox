...
class SearchRemoteDataSourceImpl @Inject constructor(
    ...
    override suspend fun getImageSearchResult(query: String, page: Int, size: Int, sort: String): SearchItemsEntity {
    ...
    override suspend fun getVideoSearchResult(query: String, page: Int, size: Int, sort: String): SearchItemsEntity {
